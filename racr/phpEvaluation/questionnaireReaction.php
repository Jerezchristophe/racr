			...
			<section class="container-fluid pl-5 mt-5">           
                <div class="row justify-content-center">
                    ...
                    <div class="card border-info">
                            <div class="card-header text-center">Questionnaire reaction</div>
                            <div class="card-body">
								<small class="text-muted">N = pas de réponse, les champs de texte vide seront considérés comme tel.</small>
								<form action="evaluationFunction.php?page=1" method="post" enctype="multipart/form-data">
									<ol class="questionOl">
										<?php
											require_once"evaluationFunction.php";
											$affichage=affichageQuestion();
											foreach($affichage as $question){
													//j'affiche les question de catégorie 1 uniquement
												...
												<?php if($question['typeQuestion'] == 0){?>
														<!-- affichage d'un input range si le type de question est égal a 0, sinon c'est un textarea -->
