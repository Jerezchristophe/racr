...
<head>
    ...
    <?php
		require_once('formationFunction.php');//appel du fichier fonction pour permettre l'affichage
		$affichEdit=affichageEditionFormation();
        ...
        <!-- Corps de page -->
            ...
            <div class="container col-10 col-md-8 col-lg-6 formulaire">
                <div class="card border-info mb-3">
                    <div class="card-header text-center">Editer</div>
                    <div class="card-body">
                        <!-- formulaire -->
                        <form class="pt-3" method="post" action="formationFunction.php" enctype="multipart/form-data">       
                            <div class="row justify-content-center">
                            <input type="hidden" name="id" value="<?=$ed['idFormation']?>">
                                <div class="form-group col-8"> 
                                    <label for="intitule">Intitulé</label>
                                    <input type="text" class="form-control" name="intitule" value="<?=$ed['intituleFormation']?>">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                            <div class="form-group col-8">
                                    <label for="domaine">Domaine</label>
                                    <input type="text" class="form-control" name="domaine" value="<?=$ed['domaineFormation']?>">
                                </div>  
                            </div>
                            <div class="row justify-content-center">
                                <div class="form-group col-8"> 
                                    <label for="dateDebut">Date de début</label>
                                    <input type="date" class="form-control" name="dateDebut" value="<?=$ed['dateDebutFormation']?>">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                            <div class="form-group col-8">
                                    <label for="dateFin">Date de fin</label>
                                    <input type="date" class="form-control" name="dateFin" value="<?=$ed['dateFinFormation']?>">
                                </div>  
                            </div>
